...
<div class="sidebar-menu">
    ...
    <a href="<%=request.getContextPath()%>/PaymentServlet" class="menu-item <%= request.getRequestURI().contains("payment-methods.jsp") ? "active" : "" %>">
        <span class="menu-icon"><i class="fas fa-credit-card"></i></span> Payment Methods
    </a>
