                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            ...
                                            <a href="../OrderServlet?action=cancel&id=<%= order.getId() %>" class="btn-delete" title="Cancel Order" onclick="return confirm('Are you sure you want to cancel this order?')">
