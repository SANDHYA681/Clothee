                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        ...
                        <div class="product-buttons">
                            <a href="CartServlet?action=add&productId=<%= product.getId() %>" class="btn btn-primary">Add to Cart</a>
                            <a href="ProductDetailsServlet?id=<%= product.getId() %>" class="btn btn-secondary">View</a>
                        </div>
                    </div>
                </div>
            <% }
