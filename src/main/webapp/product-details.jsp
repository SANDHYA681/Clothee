        ...
        <div class="product-details">
            <div class="product-gallery">
                ...
                <div class="product-main-image">
                    <img src="<%= allImages.get(0) %>" alt="<%= product.getName() %>" id="mainImage">
                ...
                <div class="product-thumbnails">
                    ...
                    %>
                    <div class="product-thumbnail <%= i == 0 ? "active" : "" %>" onclick="changeMainImage('<%= imgUrl %>', this)">
                        <img src="<%= imgUrl %>" alt="<%= product.getName() %> - Image <%= i+1 %>">
                    </div>
                    <%
                        }
                    } catch (Exception e) {
                    ...
                    <% for (Product relatedProduct : relatedProducts) { %>
                        <div class="product-card">
                            <div class="product-image">
                                <img src="<%= (relatedProduct.getImageUrl() != null && !relatedProduct.getImageUrl().isEmpty()) ? relatedProduct.getImageUrl() : "images/placeholder.jpg" %>" alt="<%= relatedProduct.getName() %>">
...
<script>
    ...
    function changeMainImage(imageUrl, thumbnailElement) {
        try {
            ...
            if (mainImage) {
                mainImage.src = imageUrl || 'images/products/placeholder.jpg';
            }
