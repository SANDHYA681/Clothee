        ...
        <div class="header-container">
            ...
            <div class="nav-icons">
                ...
                <% } else { %>
                    ...
                    <!-- Messages Icon -->
                    <a href="<%=request.getContextPath()%>/messages" class="nav-icon <%= pageName.equals("messages-view.jsp") || pageName.equals("view-message.jsp") || request.getServletPath().contains("/messages") ? "active" : "" %>" title="My Messages">
                        <i class="fas fa-envelope"></i>
                    </a>
