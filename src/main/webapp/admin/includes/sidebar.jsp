...
<div class="admin-sidebar" id="sidebar">
    ...
    <div class="admin-menu">
        ...
        <a href="<%= request.getContextPath() %>/admin/settings.jsp" class="admin-menu-item <%= pageName.equals("settings.jsp") || pageName.equals("profile-settings.jsp") || pageName.equals("security-settings.jsp") || pageName.equals("appearance-settings.jsp") ? "active" : "" %>">
