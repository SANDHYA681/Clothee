...
if (productIdParam != null && !productIdParam.isEmpty()) {
    try {
        ...
        // Invalid product ID
        response.sendRedirect("products.jsp?error=true&message=Invalid+product+ID");
        return;
    }
}
...
if (productId > 0) {
    ...
    if (product == null) {
        // Product not found
        response.sendRedirect("products.jsp?error=true&message=Product+not+found");
        return;
    }
} else {
                ...
                <div class="upload-container">
                    <form action="../ImageServlet" method="post" enctype="multipart/form-data" id="uploadForm">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" id="productImage" name="productImage" style="display:none;" accept="image/*" required>
