    ...
    <div class="dashboard-container">
        ...
        <div class="main-content">
            <div class="content-header">
                ...
                <a href="order-details.jsp?id=<%= order.getId() %>" class="btn-back">
                ...
                <div class="form-container">
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="shippingAddress" id="shippingAddress" class="form-control" rows="3"><%= order.getShippingAddress() != null ? order.getShippingAddress() : "" %></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" name="paymentMethod" id="paymentMethod" class="form-control" value="<%= order.getPaymentMethod() != null ? order.getPaymentMethod() : "" %>">
                            </div>
                            <div class="form-group">
                                <label for="totalPrice" class="form-label">Total Price</label>
                                <input type="number" name="totalPrice" id="totalPrice" class="form-control" value="<%= order.getTotalPrice() %>" step="0.01" min="0" required>
                            </div>
                    ...
                    <div class="action-buttons">
                        <a href="order-details.jsp?id=<%= order.getId() %>" class="btn btn-secondary">Cancel</a>
