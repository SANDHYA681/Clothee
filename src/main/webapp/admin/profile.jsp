...
<body>
    <div class="dashboard-container">
                ...
                <div class="user-info">
                    <div class="user-avatar">
                        ...
                        <div class="user-avatar-overlay">
                            <form id="profileImageForm" action="../ProfileImageServlet" method="post" enctype="multipart/form-data">
                                <input type="file" id="profileImageInput" name="profileImage" accept="image/*" style="display: none;">
                                <button type="button" class="btn-change-avatar" id="changeProfileImageBtn">
        ...
        <div class="main-content">
            ...
            <div class="profile-card">
                ...
                <form id="passwordForm" action="../ProfileServlet" method="post">
    ...
    <script>
        ...
        // Profile form submission - using regular form submission now
        const profileForm = document.getElementById('profileForm');
        const updateProfileBtn = document.getElementById('updateProfileBtn');

        // No need for event listener as we're using regular form submission

        // Password form submission with client-side validation
        ...
        passwordForm.addEventListener('submit', (e) => {
            ...
            if (newPassword !== confirmPassword) {
                e.preventDefault();
                showMessage('passwordErrorMessage', 'Passwords do not match');
                return false;
            }
            ...
            if (!passwordRegex.test(newPassword)) {
                e.preventDefault();
                showMessage('passwordErrorMessage', 'Password does not meet requirements');
                return false;
            }
