...
public class SettingsServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch (action) {
            ...
            case "updateAppearance":
                updateAppearanceSettings(request, response, user);
                break;
            default:
                response.sendRedirect(request.getContextPath() + "/admin/settings.jsp");
        }
     ...
     */
    private void updateAppearanceSettings(HttpServletRequest request, HttpServletResponse response, User user) throws ServletException, IOException {
        String colorTheme = request.getParameter("colorTheme");
        String fontSize = request.getParameter("fontSize");
        String compactSidebar = request.getParameter("compactSidebar");
        String fixedHeader = request.getParameter("fixedHeader");
        String darkMode = request.getParameter("darkMode");

        // Store settings in session
        HttpSession session = request.getSession();
        session.setAttribute("adminColorTheme", colorTheme);
        session.setAttribute("adminFontSize", fontSize);
        session.setAttribute("adminCompactSidebar", compactSidebar != null);
        session.setAttribute("adminFixedHeader", fixedHeader != null);
        session.setAttribute("adminDarkMode", darkMode != null);

        // Set success message and redirect
        session.setAttribute("successMessage", "Appearance settings updated successfully");
        response.sendRedirect(request.getContextPath() + "/admin/settings.jsp");
    }
