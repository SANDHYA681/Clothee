        ...
        <aside class="admin-sidebar" id="adminSidebar">
            <div class="admin-sidebar-header">
                <a href="<%=request.getContextPath()%>/admin/dashboard.jsp" class="admin-sidebar-logo">
                    ...
                    <span class="admin-sidebar-logo-text">CLOTHEE Admin</span>
                </a>
                    ...
                    <div class="admin-header-actions">
                        ...
                        <div class="admin-header-user">
                            <div class="admin-header-user-avatar">
                                <img src="<%=request.getContextPath()%>/images/avatars/admin-avatar.jpg" alt="Admin Avatar" onerror="this.src='<%=request.getContextPath()%>/images/avatars/default-avatar.jpg'">
                            </div>
                            <div class="admin-header-user-info">
                                <div class="admin-header-user-name"><%= userName %></div>
                                <div class="admin-header-user-role">Admin</div>
                            </div>
                        </div>
                    </div>
                </div>
