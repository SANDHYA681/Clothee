                    ...
                    <div class="admin-header-actions">
                        ...
                        <div class="admin-header-user">
                            ...
                            <div class="admin-header-user-info">
                                <div class="admin-header-user-name"><%= currentUser != null ? currentUser.getFullName() : userName %></div>
                                <div class="admin-header-user-role"><%= currentUser != null ? currentUser.getRole() : "Admin" %></div>
                            </div>
                        </div>
                    </div>
                </div>
