...
// Get product and review from request attribute
...
if (review.getUserId() != user.getId() && !user.isAdmin()) {
    response.sendRedirect(request.getContextPath() + "/ProductServlet?action=detail&id=" + product.getId());
    return;
}
...
<head>
    ...
    <title>Edit Review - <%= product.getName() %></title>
    ...
    <div class="container">
        <div class="review-form-container">
            <div class="review-form-header">
                ...
                <p>Update your review for this product</p>
            </div>
            ...
            <div class="delete-review">
                <p>If you no longer want to keep this review, you can delete it.</p>
                <a href="ReviewServlet?action=delete&reviewId=<%= review.getId() %>&productId=<%= product.getId() %>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this review? This action cannot be undone.')">Delete Review</a>
            </div>
        </div>
    </div>
