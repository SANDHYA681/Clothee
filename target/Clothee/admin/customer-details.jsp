                    ...
                    <div class="profile-header">
                        <div class="profile-image">
                            <% if (viewUser.getProfileImage() != null && !viewUser.getProfileImage().isEmpty()) { %>
                                <% if (viewUser.getProfileImage().startsWith("images/")) { %>
                                    <img src="<%= request.getContextPath() %>/<%= viewUser.getProfileImage() %>" alt="<%= viewUser.getFirstName() + " " + viewUser.getLastName() %>">
                                <% } else { %>
                                    <img src="<%= request.getContextPath() %>/images/avatars/<%= viewUser.getProfileImage() %>" alt="<%= viewUser.getFirstName() + " " + viewUser.getLastName() %>">
                                <% } %>
                            <% } else { %>
