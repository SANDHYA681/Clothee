            ...
            <div class="product-container">
                ...
                <div class="product-details">
                    <div class="product-images">
                        <img src="<%= request.getContextPath() %>/<%= product.getImageUrl() != null && !product.getImageUrl().isEmpty() ? product.getImageUrl() : "images/placeholder.jpg" %>?t=<%= System.currentTimeMillis() %>"
                        ...
                        <div class="product-thumbnails">
                            ...
                            %>
                            <img src="<%= request.getContextPath() %>/<%= imageUrl %>?t=<%= System.currentTimeMillis() %>"
                                 alt="<%= product.getName() %>" class="product-thumbnail" onclick="changeMainImage(this.src)">
                            <%
                                }
                            }
                        ...
                        <table class="product-info-table">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span class="badge featured-badge">Yes</span>
                                    <a href="<%= request.getContextPath() %>/admin/AdminProductServlet?action=toggleFeatured&id=<%= product.getId() %>" class="btn btn-secondary" style="margin-left: 10px; padding: 5px 10px; font-size: 12px;">
                                        <i class="far fa-star"></i> Remove Featured
                                    </a>
                                    <% } else { %>
                                    <span class="badge" style="background-color: #e0e0e0; color: #333;">No</span>
                                    <a href="<%= request.getContextPath() %>/admin/AdminProductServlet?action=toggleFeatured&id=<%= product.getId() %>" class="btn btn-primary" style="margin-left: 10px; padding: 5px 10px; font-size: 12px;">
