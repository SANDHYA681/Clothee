...
<body>
    ...
    <div class="confirm-box">
        <div class="confirm-content">
            ...
            <h2 class="confirm-title">Confirm Customer Deletion</h2>
            ...
            <div class="customer-info">
                <div class="customer-id">ID: <%= userToDelete.getId() %></div>
                <div class="customer-name"><%= userToDelete.getFirstName() %> <%= userToDelete.getLastName() %></div>
                <div class="customer-email"><%= userToDelete.getEmail() %></div>
            ...
            <div class="action-buttons">
                <a href="<%= request.getContextPath() %>/admin/customers.jsp" class="btn btn-cancel">
                    Cancel
                </a>

                <form action="<%= request.getContextPath() %>/AdminUserServlet" method="get" style="display: inline;">
