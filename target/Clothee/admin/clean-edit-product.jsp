    ...
    <div class="container">
        ...
        <form action="<%= request.getContextPath() %>/admin/AdminProductServlet" method="post">
            ...
            <div class="checkbox-group">
                <!-- Use a single checkbox with JavaScript to set the value -->
                <input type="checkbox" id="featured" name="featured" value="<%= product.isFeatured() ? "true" : "false" %>" <%= product.isFeatured() ? "checked" : "" %> onclick="this.value=this.checked ? 'true' : 'false'">
