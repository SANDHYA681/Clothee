...
<!-- Include the admin panel header with sidebar -->
<jsp:include page="../includes/admin-panel-header.jsp" />
...
<div class="admin-card">
    <div class="admin-card-header">
        <h2 class="admin-card-title">Top Products</h2>
        <a href="#" class="admin-card-action">View All Products</a>
    </div>
    ...
    <table class="admin-table">
        ...
        <tbody>
            <tr>
                ...
                <td>$29.99</td>
                <td>125</td>
                <td><span class="admin-status-badge success">In Stock</span></td>
                <td>
                    <a href="#" class="admin-action-btn"><i class="fas fa-eye"></i></a>
                    <a href="#" class="admin-action-btn"><i class="fas fa-edit"></i></a>
                </td>
            ...
            <tr>
                ...
                <td>$85.50</td>
                <td>87</td>
                <td><span class="admin-status-badge warning">Low Stock</span></td>
                <td>
                    <a href="#" class="admin-action-btn"><i class="fas fa-eye"></i></a>
                    <a href="#" class="admin-action-btn"><i class="fas fa-edit"></i></a>
                </td>
            ...
            <tr>
                ...
                <td>$199.99</td>
                <td>65</td>
                <td><span class="admin-status-badge danger">Out of Stock</span></td>
                <td>
                    <a href="#" class="admin-action-btn"><i class="fas fa-eye"></i></a>
                    <a href="#" class="admin-action-btn"><i class="fas fa-edit"></i></a>
                </td>
...
<jsp:include page="../includes/admin-panel-footer.jsp" />
